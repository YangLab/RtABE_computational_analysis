...
Deepseq_batch_id=20230927 ## change this 
source_path=/data/bioind1/reads/2023/2023.09.27_293FT_Hela_CG_FS_Nova ## change this
project_path=/data/bioind2/yuanguohua/RNAtBE_CFBI/20231007_CG_ADAR_efficiency ## change this
work_path=${project_path}

start_index=1 ## change this
end_index=90 ## change this
...
memkdir $fqlink_path
cd $source_path
ls */*combined*.gz|awk -F"_|-" '{sample_index0=$6;sample_index=(sample_index0-231509);print "ln -sf '$source_path'/"$0" '$fqlink_path'/'$Deepseq_batch_id'DeepSeq_"sample_index"_"$NF}' |bash  ## change this, specifical 231509
